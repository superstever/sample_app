...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    end #End "for non-signedin users"
  ...
  describe "PUT 'update'" do
    ...
    end #End "failure" from "PUT 'update'"
    ...
    end #end "success" from "Put 'update'"
  end # end "PUT 'update'"
  ...
  describe "authentication of edit/update pages" do
    ...
    describe "for non-signed-in users" do
      ...
      # how does this test enter in a non-signed in user? it uses Factory(:user)
      # which has a signed in user.
      
      it "should deny access to 'update'" do
        put :update, :id => @user, :user => {}
        response.should redirect_to(signin_path)
      end
    end #End for "non-signed-in users" in "authenticatio of edit/update"
    ...
    end #End of "for signed-in users" from "authentication 'edit/update"
    
  end #End "authentication 'edit/update"
  ...
  describe "follow pages" do
    ...
    end #end "when not signed in" from "follow pages"
